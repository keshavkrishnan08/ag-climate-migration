...
print(f"  R1 GE premium avg residual 2024-2050: ${out['R1_insurance_premium_GE']['ge_avg_residual_over_2024_2050_B']}B")
print(f"  R3 Infrastructure benchmark range: {out['R3_infrastructure_validation']['total_infra_range_B']} (paper: $36B)")
print(f"  R4 AgMIP levels R^2: spectrum={out['R4_AgMIP_apples_to_apples']['spectrum_levels_R2_median']}")
print(f"  R6 Stranded 3D grid: {out['R6_stranded_3D_grid']['min_B']}-{out['R6_stranded_3D_grid']['max_B']}B (median {out['R6_stranded_3D_grid']['median_B']})")
print(f"  R8 Depop empirical SSP median: ${out['R8_depop_NPV_empirical_SSP']['median_B']}B")
print(f"  R10 Common-cause excess over independence: {out['R10_common_cause_IRT']['excess_over_independence_pct']}%")
