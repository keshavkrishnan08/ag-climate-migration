...
print(f"  Yield per-crop R^2 + bootstrap CI computed for {len(out['F6_yield_per_crop_bootstrap_R2'])} crops")
print(f"  Romano-Wolf: {out['F7_migration_RomanoWolf']['all_significant_after_RW_5pct']}/6 migration specs survive at p<0.05")
